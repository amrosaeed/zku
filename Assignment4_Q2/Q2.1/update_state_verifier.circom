...
/// Assignment 4 Q2.1.4, UpdateStateVerifier (Circuit)
...
// for each proof, update 2**m transactions
    ...
    for (var i = 0; i < 2**m; i++) {
        ...
        /// Validate transaction existence within the 
        /// provided signature parameters X,Y.
        ...
        /// Validate the existence of sender's balance in the path to root "tree".
        ...
        /// Compare the sender's balance before & after sending the amount
        
        balanceFrom[i] - amount[i] <= balanceFrom[i]
      
        /// Compare the reciever's balance before & after recieving the amount
        ...
        /// Substract the amount sent from the sender balance and icrement it's nonce.
        ...
        /// Compute root from the new sender and get 
        /// the merkle root leaf correspondant.
        ...
        /// Fund the newReciever balance with the amount, if and only if 
        /// reciever hasn't zero balance.
        ...
        /// Validate that the intermidate root is consistent with the input
